...
const showVal = (hasSchema, schemaMap, k, v) =>
  hasSchema && (schemaMap[k]?.type || "").startsWith("Key to ")
    ? span({
        "data-source-url": `/field/show-calculated/${schemaMap[k].type.replace(
          "Key to ",
          ""
